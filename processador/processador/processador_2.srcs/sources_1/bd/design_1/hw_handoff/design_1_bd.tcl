...
proc create_root_design { parentCell } {
  ...
  set dout_in [ create_bd_port -dir I -from 3 -to 0 dout_in ]
  ...
  connect_bd_net -net Net [get_bd_pins cpu_0/ROM_addr] [get_bd_pins cpu_vga_dbg_0/PC] [get_bd_pins rom_0/address]
  ...
  connect_bd_net -net cpu_0_d_out_vga [get_bd_pins cpu_0/d_out_vga] [get_bd_pins cpu_vga_dbg_0/dout_vga]
  ...
  connect_bd_net -net cpu_0_dbg_sp [get_bd_pins cpu_0/dbg_sp] [get_bd_pins cpu_vga_dbg_0/SP_reg]
  connect_bd_net -net cpu_0_dbg_state [get_bd_pins cpu_0/dbg_state] [get_bd_pins cpu_vga_dbg_0/state]
  connect_bd_net -net cpu_0_flag_status [get_bd_pins cpu_0/flag_status] [get_bd_pins cpu_vga_dbg_0/flag_status]
  connect_bd_net -net cpu_0_led [get_bd_ports led_0] [get_bd_pins cpu_0/led]
  ...
  connect_bd_net -net dout_in_0_1 [get_bd_ports dout_in] [get_bd_pins cpu_0/dout_in]
  ...
  connect_bd_net -net terminal_vga_0_VGA_HS_O [get_bd_ports VGA_HS_O] [get_bd_pins terminal_vga_0/VGA_HS_O]
  connect_bd_net -net terminal_vga_0_VGA_R [get_bd_ports VGA_R] [get_bd_pins terminal_vga_0/VGA_R]
  connect_bd_net -net terminal_vga_0_VGA_VS_O [get_bd_ports VGA_VS_O] [get_bd_pins terminal_vga_0/VGA_VS_O]
